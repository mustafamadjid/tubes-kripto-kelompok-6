...
def test_build_vote_plaintext_uses_required_format():
    ...
    assert plaintext == "voter_id:VOTER001|candidate_id:2|timestamp:2026-05-22T14:30:00+07:00"
...
def test_parse_vote_plaintext_returns_structured_data():
    ...
    assert parsed.voter_id == "VOTER001"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "voter_id:VOTER001|timestamp:2026-05-22T14:30:00+07:00",
        "voter_id:VOTER001|candidate_id:2",
        "voter_id:VOTER001|candidate_id:abc|timestamp:2026-05-22T14:30:00+07:00",
        "voter_id:VOTER001|candidate_id:2|timestamp:not-a-date",
    ],
)
